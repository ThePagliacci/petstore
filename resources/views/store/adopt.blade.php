...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="active nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                              Adoption
                            </a>
        ...
        <div class="container">
          <div class="row">
            <h2>Animals That are Avaliable at Our Shilter</h2><br>

                    <div class="col-md-4 col-sm-12 category">
                      <a href="#">
                      <img class="choices" src="img/kitten-g5d6ac8c22_1920.jpg" width="300" alt="">
                      <div class="middle">
                        <div class="text">
                          Cats.
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 category">
                      <a href="#">
                      <img class="choices" src="img/puppy-ga8fca856c_1920.jpg" width="300" alt="">
                      <div class="middle">
                        <div class="text">
                            Puppies
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 category">
                      <a href="#">
                        <img class="choices" src="img/cute-g4bedc6713_1920.jpg" width="300" alt="">
                        <div class="middle">
                          <div class="text">
                            Other Pets
                          </div>
