                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="active nav-link" href="/lost">Lost & Found</a>
                          </li>
          ...
          <div class="row">
            <div class="container-fluid">
              ...
              @endif
                ...
                <a class="nav-link" href="/posts/create">Want to Post About Your Lost Pet?</a>

                  @foreach ($posts as $post )
                  <div class="col-md-4 col-sm-12">
                    <a href="/posts/{{ $post->id }}">
                      <img class="choices" src="{{ asset('storage/'.$post->image) }}" width="300" alt="">
                    </a>
