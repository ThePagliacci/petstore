            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <div class="container-fluid">
                  <a class="navbar-brand" href="/">
                    <img src="{{ asset('img/600a25a0ae8e4e0aa56ec1a1eadcdcac (1).png')}}" width="100" height="100" alt="">
                </a>
          ...
          <div class="row">
            <div class="container-fluid">
                ...
                <div class="col-8 offset-2">
                    <div class="row mb-3">
                        <label for="description" class="col-md-4 col-form-label text-md-end">Edit Description</label>
    
                        <div class="col-md-6">
                            <textarea name="description" id="description" type="text" class="form-control 
                            @error('description') is-invalid @enderror" 
                            cols="10" rows="5" description="description" 
                            value="{{ old('$post->description') }}" 
                            required autocomplete="description" autofocus>{{$post->description}}
                            </textarea>
